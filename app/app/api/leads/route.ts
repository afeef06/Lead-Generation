...
export async function POST(req: NextRequest) {
  ...
  const { data: lead, error } = await supabase
    ...
    .insert({
      ...
      framework_score: body.opportunity_score ?? body.framework_score ?? null,
      framework_reasoning: body.framework_reasoning ?? null,
      service_secondary: body.service_secondary ?? null,
      website_score: body.website_score ?? null,
      ads_score: body.ads_score ?? null,
      consulting_score: body.consulting_score ?? null,
